    ...
    try {
      ...
      if (data.pendingApproval) {
        await showAlert({
          ...
          description: data.message || (editingReceiptId ? "Permintaan edit nota berhasil diajukan! Menunggu verifikasi dari admin lain." : "Nota berhasil diajukan! Menunggu persetujuan (approval) oleh Admin (Rama / Admin 1)."),
          variant: "success",
        })
      } else {
